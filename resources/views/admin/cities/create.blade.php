<x-app-layout>
    <div class="bg-slate-200 shadow-sm max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h2 class="font-semibold text-3xl">Add New City</h2>
    </div>
    ...
    <div class="max-w-4xl mx-auto mt-6 bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.cities.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="name" class="block text-lg font-semibold text-gray-700">City Name</label>
            ...
            <div class="flex justify-end">
                <a href="{{ route('admin.cities.index') }}" class="bg-gray-500 text-white rounded-lg px-4 py-2 mr-4">
                    Cancel
                </a>
